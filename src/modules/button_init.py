...
def init_buttons():
    if osc.INPUT_METHOD == 1:
        debug.log("Input method 1 - 3 Buttons", log_levels.DEBUG)
        ...
        debug.log("Input method 2 - Cardputer", log_levels.DEBUG)
        ...
        sleep_button = Pin(osc.BOOT_RECOVERY_PIN, Pin.IN, Pin.PULL_UP)
    return [button_a, button_b, button_c, clicker, debug_console, sleep_button]
